...
public class TestMarshallingSpringOxm {
	...
	public static final String PATH_XML_FILE="F:/Temp/cd.xml";
...
public static Catalog getCatalog(){
		...
		nuovoCatalogo.getCds().add(primoCd);
		nuovoCatalogo.getCds().add(secondoCd);
		nuovoCatalogo.getCds().add(terzoCd);
